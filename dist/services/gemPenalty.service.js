...
export class GemPenaltyService {
     ...
     */
    static async searchByLicense(licenseNo) {
        try {
     ...
     */
    static async getPenaltyHistory(citizenId, limit = 50, skip = 0) {
        try {
     ...
     */
    static async getStatistics(officerId) {
        try {
            const where = officerId ? { appliedBy: officerId } : {};
