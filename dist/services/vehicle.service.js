...
class VehicleService {
    ...
    async getVehicleStats(vehicleId) {
        ...
        const pendingViolations = vehicle.violations.filter((v) => v.status === "PENDING").length;
        const confirmedViolations = vehicle.violations.filter((v) => v.status === "CONFIRMED").length;
