 ...
 * @access Private
 */
router.get("/", roleMiddleware([UserRole.ADMIN, UserRole.POLICE]), VehicleController.getAllVehicles);
/**
 ...
 */
router.post("/:vehicleId/assign-self", roleMiddleware([UserRole.CITIZEN]), VehicleController.assignSelfAsDriver);
/**
 * @route GET /api/vehicles/search
 * @desc Search vehicles by registration, engine, or chassis number
 * @access Private (Police/Admin)
 */
router.get("/search", roleMiddleware([UserRole.ADMIN, UserRole.POLICE]), VehicleController.searchVehicles);
