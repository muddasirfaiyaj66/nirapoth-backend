 ...
 */
router.post("/debts/:debtId/waive", roleMiddleware([UserRole.ADMIN]), DebtController.waiveDebt);
/**
 * @route GET /api/rewards/debts/all
 * @desc Get all debts in the system (Admin only)
 * @access Private (Admin)
 */
router.get("/debts/all", roleMiddleware([UserRole.ADMIN]), DebtController.getAllDebts);
