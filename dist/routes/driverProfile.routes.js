...
router.post("/create", authenticate, driverProfileController.createDriverProfile);
router.put("/:id", authenticate, driverProfileController.updateDriverProfile);
router.delete("/:id", authenticate, driverProfileController.deleteDriverProfile);
// Get driver profiles
// IMPORTANT: Specific routes MUST come before parameterized routes
router.get("/my-profile", authenticate, driverProfileController.getMyDriverProfile);
...
// Status management
router.patch("/:id/status", authenticate, driverProfileController.updateDriverStatus);
