...
router.post("/:id/resign", authenticate, assignmentController.resignFromAssignment);
router.post("/:id/terminate", authenticate, assignmentController.terminateAssignment);
// Get assignments
...
router.get("/vehicle/:vehicleId", authenticate, assignmentController.getVehicleAssignments);
