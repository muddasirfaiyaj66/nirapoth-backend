...
import { getDivisions, getDistricts, getUpazilas, searchGeoLocations, populateGeoData, } from "../controllers/bdGeo.controller";
...
router.post("/populate", authenticate, roleMiddleware(["ADMIN", "SUPER_ADMIN"]), populateGeoData);
