...
class NotificationController {
    ...
    static async getMyNotifications(req, res) {
        try {
            ...
            const is_read = req.query.isRead === "true"
                ? true
    ...
    static async createNotification(req, res) {
        try {
            const { title, message, type, priority = "NORMAL", targetUserId, targetRole, relatedEntityType, relatedEntityId, actionUrl, actionLabel, metadata, expiresAt, } = req.body;
    ...
    static async broadcastNotification(req, res) {
        try {
            ...
            const created_notifications = await Promise.all(users.map(async (user) => {
