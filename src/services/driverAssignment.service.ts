...
export class DriverAssignmentService {
   ...
   */
  static async createAssignment(data: CreateAssignmentData): Promise<any> {
   ...
   */
  static async resignFromAssignment(
    assignmentId: string,
    userId: string
  ): Promise<any> {
    const assignment = await prisma.vehicleAssignment.findUnique({
  ...
  static async getMyAssignments(
    userId: string
  ): Promise<{ asDriver: any[]; asOwner: any[] }> {
   ...
   */
  static async getDriverAssignments(driverId: string): Promise<any[]> {
    return await prisma.vehicleAssignment.findMany({
      where: { driverId },
      include: {
        vehicle: {
