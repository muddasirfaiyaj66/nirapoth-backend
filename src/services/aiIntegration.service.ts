...
export class AIIntegrationService {
   ...
   */
  static async getAccidentData(): Promise<{
    success: boolean;
    data?: any[];
    message?: string;
  }> {
  ...
  ): Promise<{ success: boolean; detections?: any[]; message?: string }> {
    try {
      ...
      logger.info(
        `Media detection request received: ${mediaType} - ${mediaUrl}`
      );
   ...
   */
  static async syncAccidentData(): Promise<{
    success: boolean;
    synced: number;
    message?: string;
  }> {
   ...
   */
  private static mapAlertTypeToIncidentType(alertType: string): string {
   ...
   */
  private static mapAlertSeverityToIncidentSeverity(
