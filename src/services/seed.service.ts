...
export class SeedService {
   ...
   */
  static async seedPoliceHierarchy(): Promise<void> {
    try {
      ...
      console.log(
        `🎉 Created police organizational hierarchy with ${await prisma.policeOrganization.count()} units`
      );
      console.log(
        `📋 Structure: Bangladesh Police → Metropolitan Units → Divisions`
      );
    } catch (error) {
   ...
   */
  static async populateBDGeoData(): Promise<void> {
    try {
