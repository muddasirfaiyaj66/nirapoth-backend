...
router.get(
  ...
  ViolationController.getAllViolations
);
...
router.post(
  "/rules",
  roleMiddleware([UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.POLICE]),
  ViolationController.createRule
);
...
router.put(
  "/rules/:ruleId",
  roleMiddleware([UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.POLICE]),
  ViolationController.updateRule
);
...
router.delete(
  ...
  ViolationController.deleteRule
);
...
router.post(
  "/:violationId/fine",
  roleMiddleware([UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.POLICE]),
  ViolationController.createFine
);
