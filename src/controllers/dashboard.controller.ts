...
export class DashboardController {
   ...
   */
  static async getRevenueData(req: AuthRequest, res: Response): Promise<void> {
    try {
      // Mock data for now
      const revenueData = [
   ...
   */
  static async getRoadCongestionData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getPoliceStationData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getUserSubmissionData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getUserRoleData(req: AuthRequest, res: Response): Promise<void> {
    try {
   ...
   */
  static async getViolationTypeData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getCaseSourceData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getComplaintStatusData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getFineStatusData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getEmergencyResponseData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
   ...
   */
  static async getTopCitizensData(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
