...
export class AIIntegrationController {
   ...
   */
  static async sendAccidentAlert(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async getAccidentData(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async getAccidentById(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  static async processMediaForDetection(
    req: Request,
    res: Response
  ): Promise<void> {
    try {
      ...
      const result = await AIIntegrationService.processMediaForDetection(
        mediaUrl,
        mediaType,
        location
      );
   ...
   */
  static async reportAccident(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await AIIntegrationService.reportAccident(
        validationResult.data
      );
   ...
   */
  static async syncAccidentData(req: Request, res: Response): Promise<void> {
    try {
