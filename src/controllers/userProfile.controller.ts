...
export class UserProfileController {
   ...
   */
  static async getDrivingLicenses(
    req: AuthRequest,
    res: Response
  ): Promise<void> {
    try {
  ...
  static async addDrivingLicense(
    ...
    try {
      ...
      const license = await UserProfileService.addDrivingLicense(
        userId,
        validatedData
      );
   ...
   */
  static async validateProfile(req: AuthRequest, res: Response): Promise<void> {
    try {
      const userId = req.user?.id;
      ...
      const profile = await UserProfileService.getUserProfile(userId);
      const validation =
        UserProfileService.validateProfileCompleteness(profile);
