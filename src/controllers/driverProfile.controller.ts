...
export const createDriverProfile = async (
  ...
  try {
    ...
    // Send notification
    await NotificationService.notifyDriverProfileCreated(userId).catch((err) =>
...
export const updateDriverProfile = async (
  ...
  try {
    ...
    const { id } = req.params;
    const profile = await DriverProfileService.updateDriverProfile(
      id,
      userId,
      req.body
    );
...
export const getDriverProfileByUser = async (
  req: Request,
  res: Response
): Promise<void> => {
  try {
  ...
  try {
    const filters = {
      ...
      minGems: req.query.minGems
        ? parseInt(req.query.minGems as string)
        : undefined,
    };
...
export const updateDriverStatus = async (
  ...
  try {
    ...
    const profile = await DriverProfileService.updateDriverStatus(
      id,
      userId,
      status
    );
